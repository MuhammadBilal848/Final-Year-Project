...
class Evaluation(Model):
    ...
    def to_dict(self):
        return {
            ...
            # 'user': self.user_id.to_dict(), // uncomment agar pora user instance chye with each evaluation
            'evaluation_date': self.evaluation_date.strftime('%Y-%m-%d'),  # Format the date as a string
        }
